  ...
  const fetchCoursesWithRanking = async (): Promise<CourseWithRanking[]> => {
    ...
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        if (response.data.data.individual_courses) {
          response.data.data.individual_courses.forEach(course => {
            allCourses.push({
        ...
        if (response.data.data.bundle_purchases) {
          response.data.data.bundle_purchases.forEach(bundle => {
            if (bundle.courses) {
