        ...
        {rankings.length >= itemsPerPage && (
          ...
          >
            <motion.button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-purple/20 border border-purple/30 text-purple rounded-lg hover:bg-purple/30 disabled:bg-gray-700/20 disabled:border-gray-700/30 disabled:text-gray-500 disabled:cursor-not-allowed transition-all duration-200"
            >
