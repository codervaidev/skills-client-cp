...
const GlobalStickyCTA: React.FC<GlobalStickyCTAProps> = ({ courseData }) => {
  ...
  return (
    <div className="fixed bottom-6 right-4 sm:right-6 lg:right-4 xl:right-8 z-[100] w-[230px] sm:w-[260px] lg:w-[240px] animate__animated animate__fadeInUp">
      ...
      {/* Main CTA Card */}
      <div className="bg-[#1C161D]/90 backdrop-blur-xl border border-white/10 rounded-[28px] lg:rounded-[32px] p-5 lg:p-6 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.6)] relative overflow-visible">
        <div className="relative z-10">
          ...
          <div className="mb-4 lg:mb-5">
            <div className="flex items-baseline gap-2 mb-1">
              ...
              <span className="text-xs lg:text-sm text-gray-500 line-through opacity-60">
                ৳{courseData.x_price}
              </span>
            </div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-500/10 text-green-400 text-[10px] font-bold rounded-full border border-green-500/20">
        ...
        <button
          ...
          className="absolute -bottom-2 -right-2 w-12 h-12 lg:w-14 lg:h-14 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 z-20 border-2 border-[#1C161D] bg-[#25d366] hover:bg-[#1da851]"
        ...
        >
          {isOpen ? (
            ...
            <svg
              ...
              viewBox="0 0 448 512"
              className="h-6 w-6 lg:h-7 lg:w-7 fill-white"
            >
